(() => {
  ...
  suite.innerHTML = `
    ...
    <section class="gl-purchase" aria-labelledby="gl-price-title">
      <div class="gl-price-copy" data-gl-reveal><p class="gl-kicker">Introductory offer · First 10 bookings</p><h2 id="gl-price-title">Guestbook Live</h2><p class="gl-price"><span>$</span>89</p><p class="gl-intro-price">Regularly $119</p><p class="gl-price-line">One event. One QR code. A whole lot of memories.</p><a class="button button-primary" href="${inquiryUrl}" target="_blank" rel="noopener">Add Guestbook Live to My Wedding</a><p class="gl-custom"><strong>Want it coordinated with your wedding?</strong> Ask about custom styling, custom photo frames, and full-service setup.</p></div>
