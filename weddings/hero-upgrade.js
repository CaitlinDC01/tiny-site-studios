(() => {
  ...
  actions.innerHTML = `
    <a class="button button-primary" href="demos/bea-milo/">Explore Bea &amp; Milo’s Wedding</a>
  ...
  art.innerHTML = `
    ...
    <a class="real-invitation-laptop" href="demos/bea-milo/" aria-label="Explore Bea and Milo’s wedding experience">
